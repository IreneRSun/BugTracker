...
{
    /// <summary>
    /// Class <c>Auth0UsrCx</c> models a UserManagementContext that manages connections to the Auth0 service.
    /// </summary>
    public class Auth0UsrCx: UserManagementContext
    {
        /// <value>
        ...
        /// <summary>
        /// Method <c>Auth0UsrCx</c> initializes the class with the relevant configurations.
        /// </summary>
        ...
        public Auth0UsrCx(string domain, string clientId, string clientSecret, string audience)
        {
            _domain = domain;
            _clientId = clientId;
        ...
        public override async Task<UserModel> GetUser(string userId)
        {
		...
		public override async Task UpdateUsername(string userId, string newName)
        {
            string? token = GetToken();
            var client = new ManagementApiClient(token, _domain);
        ...
        public override List<UserModel> SearchUsers(string searchQuery)
        {
            // search for users
