...
{
    /// <summary>
    /// Class <c>DatabaseContext</c> models a database context that manages connections to the MySQL database handling app data.
    /// Assumes the database schema is as defined in the README.
    /// </summary>
    public class MySQLDbCx: DatabaseContext
    {
        /// <value>
        ...
        /// <summary>
        /// Constructor <c>MySQLDbCx</c> creates a MySQLDbCx initialized with the given connection string.
        /// </summary>
        /// <param name="connectionString">The connection string.</param>
        public MySQLDbCx(string connectionString)
        {
        ...
        public override async Task RegisterUser(string userId)
        {
		...
		public override async Task DeleteUser(string userId)
        {
		...
		public override async Task GetUserData(UserModel user)
        {
        ...
        public override async Task SetAvatar(string userId, byte[] imageData)
        {
        ...
        public override async Task SetUserStatus(string userId, string status)
        {
        ...
        public override async Task<List<ProjectModel>> SearchProjects(string searchInput)
        {
        ...
        public override async Task<List<ProjectModel>> GetProjects(string userId)
        {
        ...
        public override async Task<ProjectModel?> GetProject(string projectId)
        {
        ...
        public override async Task AddProject(string projectName, string userId)
        {
        ...
        public override async Task DeleteProject(string projectId, string developerId)
        {
        ...
        public override async Task<List<UserModel>> GetDevelopers(string projectId)
        {
        ...
        public override async Task<bool> IsDeveloper(string userId, string projectId)
        {
        ...
        public override async Task AddDeveloper(string projectId, string developerId)
        {
        ...
        public override async Task<List<BugReportModel>> GetReports(string projectId, string filter, string sortType, string sortOrder)
        {
            // build query
        ...
        public override async Task<BugReportModel?> GetReport(string reportId)
        {
        ...
        public override async Task AddReport(string projectId, string userId,
        ...
        public override async Task<List<CommentModel>> GetComments(string reportId)
        {
            // build query
        ...
        public override async Task AddComment(string reportId, string userId, string comment)
        {
        ...
        public override async Task<List<BugReportModel>> GetTasks(string userId)
        {
        ...
        public override async Task<List<UserModel>> GetAssignees(string reportId)
        {
        ...
        public override async Task AddAssignment(string reportId, string developerId)
        {
        ...
        public override async Task DeleteAssignment(string reportId, string developerId)
        {
        ...
        public override async Task UpdateBugTag(string reportId, string tagName, string tagValue)
        {
        ...
        public override async Task AddHelpWanted(string reportId)
        {
        ...
        /// </summary>
        /// <param name="reportId">The ID of the report to set the tag of.</param>
        public override async Task RemoveHelpWanted(string reportId)
        {
        ...
        public override async Task<int> GetProjectStatistic(string projectId, string statisticType)
        {
        ...
        public override async Task<int> GetUpvotes(string reportId)
        {
        ...
        public override async Task<bool> IsUserUpvoted(string reportId, string userId)
        {
        ...
        public override async Task AddUpvote(string reportId, string userId)
        {
        ...
        public override async Task DeleteUpvote(string reportId, string userId)
        {
